  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <button
          onClick={prevSlide}
          className="absolute -left-[25px] top-1/3 transform -translate-y-1/2 rounded-full text-gray-500"
        >
          <IoIosArrowBack size={100} />
        </button>
        <button
          onClick={nextSlide}
          className="absolute -right-[25px] top-1/3 transform -translate-y-1/2 rounded-full text-gray-500"
        >
